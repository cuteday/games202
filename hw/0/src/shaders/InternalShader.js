...
(async function loadShaders() {
  PhongVertexShader = await (await fetch("src/shaders/phongShader/vertex.glsl")).text();
  PhongFragmentShader = await (await fetch("src/shaders/phongShader/fragment.glsl")).text();
})()
